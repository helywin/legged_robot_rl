...
for line in sys.stdin:
    req = json.loads(line)
    result = dict(step=True, reset=True, seed=True, render=True, render_free_steps=True, powerups=True, episode_events=True, shield_damage=True, projectile_damage=True,
